...
client.on("ready", () => {
    client.user.setActivity("Hozex-Shop | /help");
    ...
    if (isCommand(message, "new")) {
        ...
        message.guild.createChannel(`ticket-${message.author.id}`, "text").then(c => {
            ...
            const embed = new Discord.RichEmbed()
                .setColor(0xCF40FA)
                .addField(`Hey ${message.author.username}!`, `Please try explain why you opened this ticket with as much detail as possible. Our **__Support Team__** will be here soon to help.`)
                .setTimestamp();
            c.send({
                embed: embed
            });
